...
export class CrearEditarComponent implements OnInit {
  ...
  inicializarFormulario() {
    ...
    this.formUsuario = new FormGroup({
        ...
        contrasena : new FormControl (this.usuarioEdit.contrasena || '', [Validators.required, Validators.minLength(8)]),
        confirmContrasena : new FormControl (this.usuarioEdit.contrasena || '', [Validators.required]),
